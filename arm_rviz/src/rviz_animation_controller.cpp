...
#include <arm_rviz_msgs/AnimationControl.h>
#include <arm_rviz_msgs/GetAnimControllerState.h>
...
void RVizAnimationController::TopicEdited(const QString &text) {
  ...
  auto get_state_bind = [this](arm_rviz_msgs::GetAnimControllerStateRequest &req,
                               arm_rviz_msgs::GetAnimControllerStateResponse &res) {
    (void)req;  // unused
  ...
  auto get_state_so = create_service_options(arm_rviz_msgs::GetAnimControllerState, srv_name, get_state_bind);
...
PLUGINLIB_EXPORT_CLASS(arm_rviz::RVizAnimationController, rviz::Panel)